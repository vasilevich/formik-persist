...
var loadState = function (This) { return __awaiter(_this, void 0, void 0, function () {
    var l, l;
    return __generator(this, function (_a) {
        if (This.props.isSessionStorage === true) {
            l = window.sessionStorage.getItem(This.props.name);
            if (l) {
                return [2, JSON.parse(l)];
            }
        }
        else if (This.props.isLocalStorage === true) {
            l = window.localStorage.getItem(This.props.name);
            if (l) {
                return [2, JSON.parse(l)];
            }
        }
        else {
            return [2, localforage.getItem(This.props.name)];
        }
        return [2, null];
    });
}); };
var load = function (This) { return __awaiter(_this, void 0, void 0, function () {
    var maybeState, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, loadState(This)];
            case 1:
                maybeState = _c.sent();
                if (!(maybeState && maybeState !== null)) return [3, 3];
                _b = (_a = This.props.formik).setFormikState;
                return [4, This.props.loadFilter(maybeState)];
...
var PersistImpl = (function (_super) {
    ...
    PersistImpl.prototype.PersistImpl = function (props) {
        if (!(props.isSessionStorage || props.isLocalStorage)) {
            localforage.config(__assign({ driver: localforage.WEBSQL, name: 'formik-persist', version: 1.0, storeName: 'formik_persist', description: 'persist formik values' }, (props.localForageConfig || {})));
        }
    };
